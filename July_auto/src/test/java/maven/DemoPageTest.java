...
public class DemoPageTest extends BaseClass{
    ...
    public void setup() throws IOException {
    	driver = lauchBrowser();
    	log.info("lauched Browser");
    }
	@Test()//priority = 0,groups = {ProjectParameters.SMOKE,ProjectParameters.REGRESSION})//{"Smoke","Regression"})      //If we dont provide priority then that test is considered as high priority i.e.=0
    ...
    log.info("Hover over element perform");
   ...
   //  takeScreenshots("progressGraph");
	...
	@Test()//description = "This test will execute frames",timeOut = 2000,groups = "Regression",dependsOnMethods = "a_iframeTest")//dependsOnGroups = "Smoke")//(enabled = false,dependsOnMethods = "a_iframeTest",description = "This test will execute frames",timeOut = 1000)//(dependsOnMethods = {"a_iframeTest","testHandleMouseHover"})
